        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [Color(0xFFE91E63), Color(0xFFD2168D), Color(0xFF9C27B0)],
              ...
              const SizedBox(height: 12),
              Text(
                'To safeguard your credentials, Kozmocart utilizes direct tokenized gateway tunnels. Your payment info is secured via standard SSL and managed by global gateway operators (Stripe & Razorpay). No card details are ever saved or stored on our servers.',
                style: GoogleFonts.poppins(
                  fontSize: 12,
                  color: Colors.black54,
                  height: 1.8,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSupportCard(
              ...
              'EMAIL NOW',
              () => _launchURL('mailto:info@kozmocart.com'),
            ),
            const SizedBox(height: 16),
            _buildSupportCard(
              context,
